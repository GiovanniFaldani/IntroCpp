...
public:
	...
	// implementazione die metdoi dell'interfaccia IInterfaccia
	...
	bool SonoDiversi(int valore) {
		return a != valore; // Operatore di diversit� !=
	}
	...
	int EBitwise(int valore) {
		...
		// Risultato: 11011010 & 11111110 = 11011010 (il bit 0 � spento se era acceso, se era spento rimane spento)
